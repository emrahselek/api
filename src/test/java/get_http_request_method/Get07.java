...
public class Get07 extends JsonPlaceHolderBaseUrl {
    ...
    public void get07(){
        ...
        List<Integer> idList = json.getList("findAll{it.id>190}.id"); //findAll i want multiple data --> Groovy Language
        ...
        //Print all userId less than 5 on the console.
        ...
        //Print all titles whose id are less than 5
        List<String> titleList = json.getList("findAll{it.id<5}.title");
        System.out.println(titleList);

        //Assert that "delictus aut autem" is one of the titles whose id is less than 5
        //1.Way

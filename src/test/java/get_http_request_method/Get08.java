...
public class Get08 extends JsonPlaceHolderBaseUrl {
    ...
    public void get08(){
        ...
        expectedData.put("complated", null);
        ...
        assertEquals(expectedData.get("complated"), actualData.get(null));
        assertEquals(expectedData.get("Status Code"), response.statusCode());
